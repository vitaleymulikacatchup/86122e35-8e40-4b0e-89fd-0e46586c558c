...
export const metadata: Metadata = {
  title: "Scooby Learning - Kids Web Development & Coding",
  description: "Learn web development and coding through mystery-solving adventures. Interactive platform for kids ages 7-14. Start your learning adventure today.",
  keywords: "kids coding, web development learning, children programming, educational platform, interactive learning",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "Scooby Learning - Kids Web Development & Coding",
    description: "Learn web development and coding through mystery-solving adventures. Interactive platform for kids ages 7-14.",
    type: "website",
    siteName: "Scooby Learning"
  },
  twitter: {
    card: "summary_large_image",
    title: "Scooby Learning - Kids Web Development & Coding",
    description: "Learn web development and coding through mystery-solving adventures."
  }
};
